	...
	<nav>
		...
		<div class="nav-items nav-items2">
			<ul class="overview">
				...
				<li><a class="" href="#"  data-toggle="modal" data-target="#exampleModal"> Account Setting</a></li>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" id="exampleModalLabel"><i class="fa fa-gear"></i> Account Setting </h4>
				</div>
				<div class="modal-body">
					<h4> <i class="	fa fa-lock" style="margin-right: 5px;"></i> Change Password</h4>
					...
					<br>
					<input id="confirm_pass" type="password" class="form-control" placeholder="Confirm Password">
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
					<button type="button" class="savepass-btn btn btn-primary">Save changes</button>
				</div>
			</div>
		</div>
	</div>
				...
				<table>
					<tr>
						...
						<td>
							...
							<label for="sc">SC/PWD</label>

						</td>
					</tr>
					<tr id="hidden-tr1">
						<td colspan='2'><input type="text" id="scname" name="scname" placeholder="Name"><input id="scno" placeholder="SC/PWD No." type="text" name="scno"></td>
					</tr><!-- hidden tr --> 
					<tr id="hidden-tr2">
