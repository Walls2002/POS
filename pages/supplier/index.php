...
<meta charset="utf-8">
<meta charset="utf-8">
	<title>Point-Of-Sale | Supplier</title>
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
	<link rel="stylesheet" type="text/css" href="../../style/supplier.css">
  ...
  <main>
		<div class="container">
			...
			<div style="padding: 0;" class="container modal-btn">
					...
					<div class="modal-dialog modal-dialog-centered" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h4 class="modal-title" id="exampleModalLongTitle"><i style="font-size: 15px;" class='fas fa-pen'></i> Edit Supplier</h4>
							</div>
							<div class="modal-body">
								<label for="edit_supp_name">Name</label>
								<input type="text" class="form-control" id="edit_supp_name" name="">

								<label for="edit_supp_company_name">Company Name</label>
								<input type="text" class="form-control" id="edit_supp_company_name" name="">

								<label for="edit_supp_tell">Tell No./Cell No.</label>
								<input type="number" class="form-control" id="edit_supp_tell" name="">

								<label for="edit_supp_email">Email</label>
								<input type="email" class="form-control" id="edit_supp_email" name="">

								<label for="edit_supp_add">Address</label>
								<input type="text" class="form-control" id="edit_supp_add" name="">
							</div>
							<div class="modal-footer">
								<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
								<button type="button" id="" class="btn btn-primary save-edit-supplier">Save changes</button>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<label for="add_supp_name">Name*</label>
								<input type="text" class="form-control" id="add_supp_name" name="">

								<label for="add_supp_company_name">Company Name*</label>
								<input type="text" class="form-control" id="add_supp_company_name" name="">

								<label for="add_supp_tell">Tell No./Cell No.*</label>
								<input type="text" class="form-control" id="add_supp_tell" name="">

								<label for="add_supp_email">Email</label>
								<input type="text" class="form-control" id="add_supp_email" name="">

								<label for="add_supp_add">Address</label>
								<input type="text" class="form-control" id="add_supp_add" name="">
							</div>
							<div class="modal-footer">
								<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
				...
				<button class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-plus"></i> Add Supplier</button>
			</div>
					...
					if ($result -> num_rows > 0) 
					{
						while ($row = $result -> fetch_assoc()) 
						{
							...
							<tr id="<?php echo $row["id"];?>">
								...
								<td><button  data-toggle="modal" data-target="#exampleModalCenter" id="supplier-edit-btn" class="btn btn-info"><i style="font-size: 15px;" class='fas fa-pen'></i></button>
                  <button id="delete-supplier" type="button" class="btn btn-danger"><i style="font-size: 15px;" class='far fa-trash-alt'></i></button>
