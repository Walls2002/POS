...
$sql = "SELECT * FROM account WHERE position='admin'";
$result = $conn -> query($sql);

$sql2 = "SELECT * FROM account WHERE position='cashier'";
...
<head>
	<meta charset="utf-8">
	<title>Point-Of-Sale | Accounts</title>
	...
	<main>
		<div class="container">
			<div class="page-header">
				<h2><i class='fas fa-user-alt'></i> Accounts</h2>      
			</div>
			...
			<div class="modal fade bd-example-modal-sm" id="col-admin" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
				<div class="modal-dialog modal-sm">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title" id="exampleModalLongTitle"><i class="fa fa-lock"></i> Verify Admin Account</h4>
						</div>
						<div class="modal-body">
							<input type="text" name="" placeholder="Username" class="form-control input-verify" id="username-verify">
							<br>
							<input type="password" name="" placeholder="Password" class="form-control input-verify" id="password-verify" >
						</div>
						<div class="modal-footer">
							<button type="button" id="close-verify" class="btn btn-secondary" data-dismiss="modal">Close</button>
							<button id="verify-btn" type="button" class="btn btn-success">Verify</button>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="accordion" id="accordionExample">
				<button type="button" class="user col-btn1"  aria-expanded="false" aria-controls="collapseExample"><span><i class="fa fa-lock"></i> &nbsp;Admin</span><i class="fa fa-angle-down"></i></button>
				<div class="collapse" id="collapseExample1">
					<div style="padding-top: 20px;padding-bottom: 20px;" class="container-fluid">
					...
					<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
						<div class="modal-dialog modal-dialog-centered" role="document">
							<div class="modal-content">
								<div class="modal-header">
									<h4 class="modal-title" id="exampleModalLongTitle">Add Admin Account</h4>
								</div>
								<div class="modal-body add-admin-div">
									<label for="admin-name">Name*</label>
									<input type="text" id="admin-name" class="form-control" placeholder="Full Name">
									...
									<label for="admin-con-pass">Confirm Password*</label>
									<input type="Password" id="admin-con-pass" class="form-control" placeholder="Confirm Password">
								</div>
								<div class="modal-footer">
									<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
									<button id="add-admin-btn" type="button" class="btn btn-success">Add</button>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="modal fade" id="exampleModalCenter1" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
						<div class="modal-dialog modal-dialog-centered" role="document">
							<div class="modal-content">
								<div class="modal-header">
									<h4 class="modal-title" id="exampleModalLongTitle">Edit Admin</h4>
								</div>
								<div class="modal-body add-admin-div">
									<label for="admin-name">Name*</label>
									...
									<label for="admin-con-pass">Confirm Password*</label>
									<input type="Password" id="edit-con-pass" class="form-control" placeholder="Confirm Password">
								</div>
								<div class="modal-footer">
									<button type="button" class="btn btn-secondary" id="close-edit" data-dismiss="modal">Close</button>
									<button type="button" class="btn btn-success edit-admin-btn">Save Edit</button>
								</div>
							</div>
						</div>
					</div>
					<div class="card card-body">
						...
						<table class="table-borderless table-hover table-admin">
							<thead>
								<th>Position</th>
								<th>Name</th>
								<th>Username</th>
								...
								if ($result -> num_rows > 0) 
								{
									while ($row = $result -> fetch_assoc()) 
									{
										...
										<tr id="<?php echo $row["id"];?>">
											...
											<td><span class="password-td"><?php echo $row["password"]; ?></span> <button class="see-password"><i class='far fa-eye'></i></button></td>
											<td><button  data-toggle="modal" data-target="#exampleModalCenter1"  class="btn btn-info edit-admin"><i style="font-size: 15px;" class='fas fa-pen'></i></button>
				...
				<button type="button" class="user col-btn2"  aria-expanded="false" aria-controls="collapseExample"><span><i class="fa fa-lock"></i> &nbsp;Cashier</span><i class="fa fa-angle-down"></i></button>
				<div class="collapse" id="collapseExample2">
					<div style="padding-top: 20px;padding-bottom: 20px;" class="container-fluid">
						<button class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter3"><i class="fa fa-plus"></i> Add Cashier Account</button>
					</div>
					<!-- Add Cashier Modal -->
					<div class="modal fade" id="exampleModalCenter3" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
						<div class="modal-dialog modal-dialog-centered" role="document">
							<div class="modal-content">
								<div class="modal-header">
									<h4 class="modal-title" id="exampleModalLongTitle">Add Cashier Account</h4>
								</div>
								<div class="modal-body add-admin-div">
									<label for="cashier-name">Name*</label>
									<input type="text" id="cashier-name" class="form-control" placeholder="Full Name">

									<label for="cashier-username">Username*</label>
									<input type="text" id="cashier-username" class="form-control" placeholder="Username">

								
								</div>
								<div class="modal-footer">
									<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
									<button id="add-cashier-btn" type="button" class="btn btn-success">Add and Generate Password</button>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="modal fade" id="exampleModalCenter2" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
						<div class="modal-dialog modal-dialog-centered" role="document">
							<div class="modal-content">
								<div class="modal-header">
									<h4 class="modal-title" id="exampleModalLongTitle">Edit Cashier</h4>
								</div>
								<div class="modal-body add-admin-div">
									<label for="admin-name">Name*</label>
									<input type="text" id="edit-name-cashier" class="form-control" placeholder="Full Name">

									<label for="admin-username">Username*</label>
									<input type="text" id="edit-username-cashier" class="form-control" placeholder="Username">

									<label for="admin-pass">Password*</label>
									<input type="Password" id="edit-pass-cashier" class="form-control" placeholder="Password">

									<label for="admin-con-pass">Confirm Password*</label>
									<input type="Password" id="edit-con-pass-cashier" class="form-control" placeholder="Confirm Password">
								</div>
								<div class="modal-footer">
									<button type="button" class="btn btn-secondary" id="close-edit-cas" data-dismiss="modal">Close</button>
									<button type="button" class="btn btn-success edit-cashier-btn">Save Edit</button>
								</div>
							</div>
						</div>
					</div>
					<div style="margin-bottom: 70px;" class="card card-body">
						<table class="table-borderless table-hover table-admin">
							<thead>
								<th>Position</th>
								<th>Name</th>
								...
								if ($result2 -> num_rows > 0) 
								{
									while ($row = $result2 -> fetch_assoc()) 
									{
										...
										<tr id="<?php echo $row["id"];?>">
											...
											<td><span><?php echo $row["name"]; ?></span></td>
											<td><span><?php echo $row["username"]; ?></span></td>
											<td><span class="password-td"><?php echo $row["temp_pass"]; ?></td>
                      <td><span class="password-td"><?php echo $row["status"]; ?></td>
											<td>
												<button  type="button" class="btn btn-danger delete-cashier"><i style="font-size: 15px;" class='far fa-trash-alt'></i></button>
                        <button  type="button" class="btn btn-primary generate-btn"><i style="font-size: 15px;" class=' fa fa-refresh'></i></button>
											</td>
										</tr>
										<?php
									}
